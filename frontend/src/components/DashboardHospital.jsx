...
export default function DashboardHospital({
  ...
  const handleUpdateStock = async (group, operation) => {
    ...
    try {
      ...
      if (response.ok) {
        setProfile((prev) => ({ ...prev, bloodInventory: nextInventory }));
  ...
  const handleCreateBroadcast = async (e) => {
    ...
    try {
      ...
      setToastMsg(
        `Success! Scanned matching database: Broadcast dispatched to matching donors!`,
      );
  ...
  const handleCompleteRequest = async (requestId) => {
    try {
      const response = await fetch(
        `/api/hospitals/${hospitalId}/requests/${requestId}/complete`,
        {
          method: "PUT",
          headers: { "Content-Type": "application/json" },
        },
      ...
      if (response.ok) {
        setToastMsg(
          "Perfect! Broadcast completed & accredited inventory updated.",
        );
  ...
  // Stock aggregations
  const totalStockUnits = Object.values(profile.bloodInventory).reduce(
    (a, b) => a + b,
    0,
  );
          ...
          <div className="space-y-8 animate-in fade-in duration-200">
            ...
            >
              ...
              >
                ...
                <div className="my-4 text-left">
                  <p className="text-5xl font-black text-gray-900 dark:text-white tracking-tight leading-none">
                    {totalStockUnits}
                  </p>
              ...
              >
                ...
                <div className="my-4 text-left">
                  <p className="text-5xl font-black text-red-600 dark:text-red-500 tracking-tight leading-none">
                    {activeRequestsCount}
                  </p>
                  <p className="text-sm font-bold text-gray-800 dark:text-gray-250 mt-1">
                    Active requests
                  </p>
                </div>
                <p className="text-[11px] text-gray-400 dark:text-gray-300 font-semibold">
              ...
              >
                ...
                <div className="my-4 text-left">
                  <p className="text-5xl font-black text-emerald-600 dark:text-emerald-400 tracking-tight leading-none">
              ...
              >
                ...
                <div className="my-4 text-left">
                  <p className="text-5xl font-black text-blue-600 dark:text-blue-400 tracking-tight leading-none">
            ...
            <div className="bg-white dark:bg-[#1F2937] rounded-3xl p-6 border border-gray-150 dark:border-gray-800 shadow-xl space-y-4 transition-colors">
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-350 mt-0.5">
                  Edit available clinical quantities. Local donors can view
                  compatible inventories near Chennai.
                </p>
              </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="my-2">
                        ...
                        <p className="text-[9px] text-gray-400 dark:text-gray-300 font-bold uppercase mt-1">
                          Units
                        </p>
                      </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 bg-white dark:bg-[#1F2937] rounded-3xl p-6 md:p-8 border border-gray-150 dark:border-gray-800 shadow-xl space-y-6 text-left relative overflow-hidden transition-colors">
                ...
                <div>
                  <h3 className="font-extrabold text-gray-900 dark:text-white text-xl flex items-center gap-2">
                    <Send size={18} className="text-red-500" /> Live Emergency
                    Broadcast Center
                  </h3>
                  <p className="text-xs text-gray-500 dark:text-gray-350 mt-1">
                    Dispatches an instant emergency alert. The match system maps
                    matching, available and eligible donors instantly.
                  </p>
                </div>
                ...
                <form onSubmit={handleCreateBroadcast} className="space-y-4">
                  ...
                  <div className="pt-2 flex justify-end">
                    ...
                    >
                      {submittingBroadcast
                        ? "Matching Engine Scanning..."
                        : "Send Emergency Alert Broadcast"}
                    ...
                    notifications.map((not) => (
                      ...
                      >
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <span className="text-[9px] text-gray-400 dark:text-gray-300">
                            Just now
                          </span>
                        </div>
                        ...
                        <p className="text-[11px] text-gray-500 dark:text-gray-300 leading-normal mt-0.5">
                          {not.message}
                        </p>
                      </div>
                    ))
            ...
            <div className="bg-white dark:bg-[#1F2937] rounded-3xl p-6 border border-gray-150 dark:border-gray-800 shadow-xl text-left space-y-4 transition-colors">
              <h3 className="font-bold text-gray-900 dark:text-white text-lg">
                Broadcast Requests Tracker
              </h3>

              {requests.length === 0 ? (
                <div className="py-12 text-center text-gray-400 dark:text-gray-300 text-xs">
                  No active broadcasts registered yet. Emit emergencies using
                  the panel above.
                </div>
              ) : (
                      ...
                      {requests.map((req) => (
                        ...
                        >
                          ...
                          <td className="px-6 py-4">
                            <span className="px-2 py-0.5 bg-red-100 dark:bg-red-950 text-red-650 dark:text-red-300 rounded text-xs font-black">
                              {req.bloodGroup}
                            </span>
                          </td>
                          ...
                          <td className="px-6 py-4">
                            <span
                              className={`text-xs font-bold uppercase inline-flex items-center gap-1 ${
                            ...
                            {req.acceptedByDonorName ? (
                              <div className="flex flex-col text-left">
                                ...
                                {req.acceptedByDonorPhone && (
                                  <a
                                    href={`tel:${req.acceptedByDonorPhone}`}
                                    className="text-[11px] text-emerald-600 dark:text-emerald-400 hover:underline inline-flex items-center gap-1 mt-1 font-bold"
                                  >
                                    <Phone
                                      size={11}
                          ...
                          <td className="px-6 py-4">
                            {req.status === "accepted" ? (
                              ...
                              <span className="text-emerald-650 dark:text-emerald-400 font-extrabold text-[10px] bg-emerald-50 dark:bg-emerald-950/40 px-2 py-1 rounded">
                                Drive Complete
                              </span>
                            ) : (
            ...
            <div className="bg-white dark:bg-[#1F2937] p-6 rounded-3xl border border-gray-150 dark:border-gray-800 shadow-xl space-y-4 text-left transition-colors">
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-300">
                  Scan and locate vetted volunteer blood donors in specific
                  regions during times of disaster.
                </p>
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                <div className="space-y-1">
                  <label className="block text-[10px] font-bold text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                    Search by Name/City
                  </label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
              {filteredDonors.length === 0 ? (
                <div className="col-span-full py-16 text-center bg-white dark:bg-[#1F2937] border border-gray-150 dark:border-gray-800 rounded-3xl text-gray-400 dark:text-gray-300">
                  No compatible volunteer donor profiles matched those filters.
                  Try broad terms!
                </div>
              ) : (
                    ...
                    >
                        ...
                        <div className="space-y-1 pt-1">
                          <div className="flex justify-between items-center text-[10px] border-b border-gray-50 dark:border-gray-750 pb-1.5 text-gray-500 dark:text-gray-300">
                            ...
                            {donor.isAvailable ? (
                              ...
                              <span className="text-gray-400 dark:text-gray-500 font-bold uppercase">
                                Resting
                              </span>
                            )}
                          </div>
                          ...
                          <div className="flex justify-between items-center text-[10px] border-b border-[#fafafa] dark:border-gray-750 py-1.5 text-gray-500 dark:text-gray-300">
                            ...
                            {eligible ? (
                              <span className="text-red-600 dark:text-red-400 font-extrabold uppercase inline-flex items-center gap-0.5">
                                <CheckCircle2 size={10} /> Eligible
                              </span>
                            ) : (
                              <span className="text-amber-500 font-bold uppercase inline-flex items-center gap-0.5">
                                <AlertTriangle size={10} /> resting (
                                {90 - diffDays}d left)
                              </span>
                            )}
                          </div>
                          ...
                          <div className="flex justify-between items-center text-[10px] pt-1.5 text-gray-500 dark:text-gray-300">
                            ...
                            <span className="font-mono font-bold text-gray-900 dark:text-white">
                              {donor.lastDonationDate || "Never Registered"}
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="flex gap-1.5 flex-wrap pt-1">
                          {donor.badges &&
                            donor.badges.map((badge, bidx) => (
                              <span
                                key={bidx}
                                className="text-[9px] bg-amber-50 dark:bg-amber-950/40 border border-amber-100 dark:border-amber-900 text-amber-700 dark:text-amber-300 font-bold px-2 py-0.5 rounded-md flex items-center gap-0.5"
                              >
                                ⭐ {badge}
                              </span>
                            ))}
                      ...
                      <div className="mt-5 pt-3 border-t border-gray-100 dark:border-gray-750 flex items-center justify-between text-[11px] text-gray-500 dark:text-gray-300 font-semibold">
                        ...
                        <a
                          ...
                          className="text-red-600 dark:text-red-400 hover:underline flex items-center gap-0.5 font-bold"
                        >
            ...
            <div className="bg-white dark:bg-[#1F2937] p-6 rounded-3xl border border-gray-150 dark:border-gray-800 shadow-xl text-left space-y-4 transition-colors">
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-350">
                  Chronological history registry tracking real-time broadcast
                  dispatches, credentials verification states, database edits,
                  matching acceptances, and logs dispatch audits.
                </p>
              </div>
                    ...
                    {activityLogs.length === 0 ? (
                      ...
                      activityLogs.slice(0, 50).map((log) => (
                        ...
                        >
                          ...
                          <td className="px-6 py-3.5 font-bold font-mono tracking-tight text-[10px] text-gray-900 dark:text-white">
                            {log.action}
                          </td>
                          <td className="px-6 py-3.5 leading-relaxed text-gray-650 dark:text-gray-300">
                            {log.description}
                          </td>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
              ...
              <div className="bg-white dark:bg-[#1F2937] p-6 rounded-3xl border border-gray-150 dark:border-gray-800 shadow-xl space-y-3 transition-colors">
                ...
                <p className="text-[11px] text-gray-400 leading-normal">
                  Audit tracker logs of dispatches sent to matching donors'
                  emails to ensure eligibility alerts.
                </p>

                <div className="space-y-3 max-h-[300px] overflow-y-auto divide-y divide-gray-50 dark:divide-gray-750 pr-1">
                  {emailLogs.length === 0 ? (
                    <p className="text-center text-gray-400 dark:text-gray-300 py-6 text-xs">
                      No email packets emitted yet in this session.
                    </p>
                  ) : (
                    emailLogs.map((mail) => (
              ...
              <div className="bg-white dark:bg-[#1F2937] p-6 rounded-3xl border border-gray-150 dark:border-gray-800 shadow-xl space-y-3 transition-colors">
                ...
                <p className="text-[11px] text-gray-400 leading-normal">
                  Audit tracker log of Indian SMS dispatches parsed to active
                  mobile numbers.
                </p>
                ...
                <div className="space-y-3 max-h-[300px] overflow-y-auto divide-y divide-gray-50 dark:divide-gray-750 pr-1">
                  {smsLogs.length === 0 ? (
                    <p className="text-center text-gray-400 dark:text-gray-300 py-6 text-xs">
                      No SMS dispatches triggered yet.
                    </p>
                  ) : (
                    smsLogs.map((sms) => (
                      <div key={sms.id} className="pt-3 first:pt-0">
                        <div className="flex justify-between items-center mb-1 text-[10px] text-gray-400 dark:text-gray-350">
                          ...
                          <span
                            className={`${sms.status === "DELIVERED" ? "text-emerald-500" : "text-red-500"} font-black text-[9px] uppercase bg-gray-50 dark:bg-gray-800 px-2 py-0.5 rounded`}
                          >
                            {sms.status}
                          </span>
                        </div>
          ...
          <div className="max-w-2xl mx-auto bg-white dark:bg-[#1F2937] p-6 md:p-8 rounded-3xl border border-gray-150 dark:border-gray-800 shadow-xl space-y-6 text-left animate-in fade-in duration-200 transition-colors">
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-330 mt-1">
                Control active parameters and notifications channels allowed on
                your medical hub.
              </p>
            </div>
            ...
            <form onSubmit={handleSaveSettings} className="space-y-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-850/30 rounded-2xl border border-gray-100 dark:border-gray-700">
                  <div className="space-y-0.5 pr-4">
                    <label className="block text-sm font-extrabold text-gray-900 dark:text-white">
                      Email dispatching alerts
                    </label>
                    <span className="text-xs text-gray-400 dark:text-gray-350 leading-relaxed">
                      Emits digital mail alerts to target clinical admins and
                      matching compatible donors.
                    </span>
                  </div>
                  <button
                    type="button"
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-850/30 rounded-2xl border border-gray-100 dark:border-gray-700">
                  <div className="space-y-0.5 pr-4">
                    <label className="block text-sm font-extrabold text-gray-900 dark:text-white">
                      SMS broadcast dispatching
                    </label>
                    <span className="text-xs text-gray-400 dark:text-gray-350 leading-relaxed">
                      Pushes immediate emergency matching updates over vetted
                      mobile numbers inside India.
                    </span>
                  </div>
                  <button
                    type="button"
